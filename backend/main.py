...
from backend.api.plan_review import router as plan_review_router
...
@app.get("/")
def root():
    return {"application": APP_NAME, "message": "MARS backend is running.", "docs": "/docs", "health": "/api/health"}
