...
const plannerItems = [
  ...
  { key: 'jobs', icon: Wrench, label: 'Maintenance Jobs', children: [{ to: '/jobs', label: 'All Jobs' }, { to: '/jobs/department', label: 'By Department' }, { to: '/jobs/priority-risk', label: 'Priority & Risk' }, { to: '/jobs/add', label: 'Add Maintenance Job' }] },
...
const deptItems = {
  ...
  traction: [
    { to: '/dept/traction', icon: Home, label: 'Home', end: true }, { to: '/dept/traction', icon: Wrench, label: 'My Jobs' }, { to: '/weekly', icon: CalendarDays, label: 'My Schedule' }, { to: '/corridor', icon: Map, label: 'Corridor Map' }, { to: '/impact', icon: BarChart3, label: 'Asset Risk' }, { to: '/integration', icon: Database, label: 'TDMS Status' }, { to: '/', icon: Gauge, label: 'Planner Overview' },
  ],
};
...
export default function Sidebar({ currentRole }) {
  ...
  const [expanded, setExpanded] = useState({ planning: false, jobs: false, work: true, assets: false, coordination: false, safety: false, 'snt-work': true, 'snt-planning': false, 'snt-assets': false, 'snt-coordination': false, 'snt-safety': false });
