  ...
  return <main className="flex min-h-full flex-col gap-3 bg-[#F4F6F8] p-4 sm:p-5">
    {!fullScreen && <>
      ...
      <div className="grid grid-cols-2 gap-2 md:grid-cols-4">
        ...
        <div className="rounded-md border border-[#D6DEE6] bg-white px-3 py-2"><div className="text-[9px] font-bold uppercase tracking-wider text-[#6B5B95]">Shared Blocks</div><div className="mt-0.5 text-lg font-bold text-[#6B5B95]">{sharedBlocks}</div></div>
