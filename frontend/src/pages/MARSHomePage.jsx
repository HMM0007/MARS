        ...
        <div className="relative z-10 flex min-h-[500px] flex-col justify-between px-6 py-7 sm:px-8 lg:min-h-[525px] lg:px-14 lg:py-8">
          <div className="max-w-[700px] pt-1">
            ...
            <div className="flex flex-col items-start">
              <h1 className="m-0 font-[Arial_Black,Inter,sans-serif] text-[66px] font-black leading-[.84] tracking-[.015em] text-[#F39A24] drop-shadow-[0_4px_12px_rgba(0,0,0,.45)] sm:text-[78px] lg:text-[94px]">MARS 2.0</h1>
              <div className="mt-5 font-[Noto_Sans_Devanagari,Arial,sans-serif] text-[24px] font-semibold leading-[1.18] tracking-[.005em] text-white drop-shadow-[0_2px_7px_rgba(0,0,0,.55)] sm:text-[27px] lg:text-[30px]">
