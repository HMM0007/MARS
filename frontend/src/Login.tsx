...
export default function Login({ onLogin }: { onLogin: (department: Department) => void }) {
  ...
  const submit = (e: React.FormEvent) => { e.preventDefault(); setError(''); if (!employeeId.trim() || !password.trim()) { setError('Please enter your Employee ID and password.'); return }; onLogin(department) }
  return (
    <div className="login-page">
      <section className="login-visual-panel">
        <img className="login-railway-image" src="/railway-login.jpg" alt="Indian Railways locomotive and railway emblem" />
        <div className="login-visual-shade" />
        <div className="login-visual-content">
          <div className="login-gov-line">GOVERNMENT OF INDIA</div>
          <div className="login-ministry">MINISTRY OF RAILWAYS</div>
          <div className="login-brand-block"><div className="login-mars">MARS</div><div className="login-mars-full">Maintenance Allocation &amp; Routing System</div></div>
      ...
      <section className="login-form-panel">
        ...
        <div className="login-form-inner">
          <div className="login-portal-heading"><div className="portal-accent" /><div><span>MAINTENANCE ALLOCATION &amp; ROUTING SYSTEM</span><h2>USER LOGIN</h2></div></div>
